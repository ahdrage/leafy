"""Export final Rev E. Factory CSVs and paste contain exactly four parts."""
from pathlib import Path
import os,subprocess,csv,collections,json,hashlib,xml.etree.ElementTree as ET,html
import pcbnew as p
import cairosvg
H=Path(__file__).resolve().parent;E=H/'exports';B=H/'leaf-heat-v5.kicad_pcb'
...
run('sch','export','svg','-o',E/'schematic',H/'leaf-heat-v5.kicad_sch')
cairosvg.svg2png(url=str(E/'schematic/leaf-heat-v5.svg'),write_to=str(E/'schematic.png'),output_width=4000,background_color='white')
run('sch','export','pdf','-o',E/'schematic.pdf',H/'leaf-heat-v5.kicad_sch')
...
svg=['<svg xmlns="http://www.w3.org/2000/svg" width="1800" height="2010" viewBox="-5 -18 110 123">',
     ...
     '<text x="0" y="-11" font-family="Arial" font-size="2.9" fill="#0f172a">LEAF HEAT REV E — 100 × 100 mm</text>',
