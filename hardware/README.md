...
> **Rev A archive:** current manufacturing files are [Leafy Rev G.5](rev-g/README.md). All earlier revisions are preserved. The specifications below describe the obsolete two-layer Rev A.
