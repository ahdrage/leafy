...
native=H/'leaf-heat-v4.kicad_pcb'
...
assert sha(H/'leaf-heat-v4.kicad_sch')==audit['schematic_sha256']
...
gerber=package('leaf-heat-rev-d-gerbers.zip',fab)
...
factory_zip=package('leaf-heat-rev-d-factory-assembly.zip',factory)
...
docs=['README.md','DESIGN-REVIEW.md','HAND-ASSEMBLY.md','MANUFACTURING-NOTES.md','PROGRAMMING.md','REVIEW-IMAGES.md']
images=['board-3d.png','assembly-map.png','assembly-map.svg','placement.png','placement.svg',
        'top.png','top.svg','ground.png','ground.svg','power.png','power.svg','bottom.png','bottom.svg',
...
review_exports=images+factory_names+['BOM-HAND.csv','BOM-FULL-REFERENCE-ONLY.csv',
        ...
        'independent-audit.json','manufacturing-audit.json','leaf-heat-v4.net.xml','drill-report.txt']
source=[(H/n,'leaf-heat-rev-d/'+n) for n in docs+['leaf-heat-v4.kicad_pro','leaf-heat-v4.kicad_sch',
        'leaf-heat-v4.kicad_pcb','leaf-heat-v4.kicad_dru','Leaf.kicad_sym','sym-lib-table','fp-lib-table',
        'parts.json','testpoints.json']]
source += [(p,'leaf-heat-rev-d/Leaf.pretty/'+p.name) for p in sorted((H/'Leaf.pretty').glob('*.kicad_mod'))]
source += [(E/n,'leaf-heat-rev-d/exports/'+n) for n in review_exports]
source += [(E/'schematic/leaf-heat-v4.svg','leaf-heat-rev-d/exports/schematic/leaf-heat-v4.svg')]
source += [(p,'leaf-heat-rev-d/exports/fabrication/'+n) for p,n in fab]
package('leaf-heat-rev-d-kicad-review.zip',source)
hand=[(H/n,n) for n in ['HAND-ASSEMBLY.md','PROGRAMMING.md','DESIGN-REVIEW.md','REVIEW-IMAGES.md']]
...
package('leaf-heat-rev-d-hand-assembly.zip',hand)
review=[(E/n,n) for n in images]+[(H/n,n) for n in ['REVIEW-IMAGES.md','DESIGN-REVIEW.md']]
review += [(E/'schematic/leaf-heat-v4.svg','schematic.svg')]
package('leaf-heat-rev-d-review-images.zip',review)
(D/'manifest.json').write_text(json.dumps({'revision':'D','date':'2026-09-12','board_sha256':sha(native),
    'schematic_sha256':sha(H/'leaf-heat-v4.kicad_sch'),'packages':records},indent=2)+'\n')
