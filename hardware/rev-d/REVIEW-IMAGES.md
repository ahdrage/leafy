...
This is the 150 × 150 mm, four-layer hand-solder prototype. Factory scope is U1/U2/U4/L1 only; the completed board needs another 37 hand-fitted parts.
...
| power.png / .svg | In2.Cu supply distribution: narrow left protected-input region and large 3.3 V region, with ground elsewhere. Different nets use the same layer colour. |
