...
b=p.LoadBoard(str(H/'leaf-heat-v4.kicad_pcb'))
shutil.copy2(H/'leaf-heat-v4.kicad_pcb',E/'before-router.kicad_pcb')
assert p.ExportSpecctraDSN(b,str(E/'leaf-heat-v4.dsn'))
s=(E/'leaf-heat-v4.dsn').read_text()
def replace(m):
    t=m.group()
    if t.startswith('(plane /GND') and not '(polygon In1.Cu' in t:return ''
    if t.startswith('(plane /3V3 (polygon In2.Cu'):
        points=[(6.6,12.6),(21.4,12.6),(21.4,16.6),(23.4,16.6),(23.4,24.2),(21.4,26.2),(21.4,115.6),(34.6,115.6),(34.6,109.6),(42.4,109.6),(42.4,119.4),(6.6,119.4),(6.6,12.6)]
...
(E/'leaf-heat-v4-routing.dsn').write_text(s)
