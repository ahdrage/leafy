> **Rev A archive:** the current four-layer layout and review are in [rev-b/README.md](rev-b/README.md). The specifications below describe the preserved two-layer Rev A.
