...
ref_c = collection('02 REFERENCE — actual Rev F PCB, not for printing')
...
bpy.ops.import_scene.gltf(filepath=str(H/'reference/leaf-heat-rev-f.glb'))
...
exports=[export_stl(base,'leaf-rev-f-case-base.stl'),export_stl(lid,'leaf-rev-f-case-lid.stl',True),
...
bpy.ops.wm.save_as_mainfile(filepath=str(H/'leaf-rev-f-enclosure.blend'))
